...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Bot Bazaar`}</title>

        <meta
          name="description"
          content="Experience the future of technology with Bot Bazaar, your one-stop marketplace for innovative software products, AI tools, and plugins."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1532619675605-1ede6c2ed2b0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzb2Z0d2FyZSUyMG1hcmtldHBsYWNlfGVufDB8fHx8MTY5NDY5NTUwM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of technology with Bot Bazaar, your one-stop marketplace for innovative software products, AI tools, and plugins.`}
            </Text>
            <Box
