      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Software Product Details',
              isCurrent: true,
            },
          ]}
        />
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('software_product', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/software-products/edit/${id}`} passHref legacyBehavior>
                    <Button
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <FavoritesListPage
                filters={{ software_product_id: id }}
                hidePagination={true}
