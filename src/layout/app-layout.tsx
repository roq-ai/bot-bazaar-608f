...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'software-developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Ai Tools', path: '/ai-tools', entity: 'ai_tool', service: AccessServiceEnum.PROJECT, icon: FiCpu },
    { name: 'Favorites', path: '/favorites', entity: 'favorites', service: AccessServiceEnum.PROJECT, icon: FiStar },
    { name: 'Plugins', path: '/plugins', entity: 'plugin', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
