...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'software_product.create': {
    roles: ['business-owner', 'team-member'],
    key: 'new-software-product',
    tenantPath: ['organization', 'user', 'software_product'],
    userPath: [],
  },
  'software_product.update': {
    roles: ['business-owner', 'team-member'],
    key: 'software-product-updated',
    tenantPath: ['organization', 'user', 'software_product'],
    userPath: [],
  },
  'software_product.delete': {
    roles: ['business-owner', 'team-member'],
    key: 'software-product-deleted',
    tenantPath: ['organization', 'user', 'software_product'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'software-developer'];
